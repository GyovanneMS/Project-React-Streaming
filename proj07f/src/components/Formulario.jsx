    ...
    return <Modelo>
        <ModeloInterno onSubmit={ Enviar } >
            ...
            <input
                ...
                type="text" name="genero" placeholder="Gênero (ex.: comédia)" required/>
            ...
            <input
                ...
                type="number" name="duração" placeholder="Duração em minutos" required/>

            <input
                value={ conteudo.faixa } onChange={ Mudar }
                type="number" name="faixa" placeholder="Faixa etária" required/>
